  ...
  return (
    <><div  className="overflow-auto">
        ...
        <div className=" flex flex-col-reverse overflow-hidden lg:flex-row">
          <div className="w-full px-4 overflow-hidden pb-28 pt-10 backdrop-blur lg:max-w-[34rem] lg:grow-0 lg:px-16 lg:shadow-2xl xl:px-20">
          ...
          <div className="shrink-0  px-4 lg:min-w-0 lg:flex-1 lg:px-16 xl:px-20">
            <div className="mx-auto grid max-w-md grid-cols-1 lg:mx-0 lg:max-w-lg">
              <div className="relative py-10 lg:pt-28">Pricing Overview</div>
              <div>
